const books = [
  {id:1, title:"Tôi thấy hoa vàng trên cỏ xanh", author:"Nguyễn Nhật Ánh", category:"Văn học", price:85000,
  ...
  {id:2, title:"Đắc nhân tâm", author:"Dale Carnegie", category:"Tâm lý", price:99000,
  ...
  {id:3, title:"Nhà giả kim", author:"Paulo Coelho", category:"Văn học", price:105000,img:"https://upload.wikimedia.org/wikipedia/vi/9/9c/Nh%C3%A0_gi%E1%BA%A3_kim_%28s%C3%A1ch%29.jpg",
   desc:"Hành trình phiêu lưu và tìm kiếm ý nghĩa cuộc đời - tác phẩm truyền cảm hứng toàn cầu."},
  {id:4, title:"Cho tôi xin một vé đi tuổi thơ", author:"Nguyễn Nhật Ánh", category:"Thiếu nhi", price:78000,
  ...
  {id:5, title:"Dế mèn phiêu lưu ký", author:"Tô Hoài", category:"Thiếu nhi", price:54000,
  ...
  {id:6, title:"Tuổi thơ dữ dội", author:"Phùng Quán", category:"Văn học", price:99000,
  ...
  {id:7, title:"Số đỏ", author:"Vũ Trọng Phụng", category:"Văn học", price:69000,
  ...
  {id:8, title:"Nỗi buồn chiến tranh", author:"Bảo Ninh", category:"Văn học", price:129000,
  ...
  {id:9, title:"Tư duy nhanh và chậm", author:"Daniel Kahneman", category:"Tâm lý", price:170000,
  ...
  {id:10, title:"Tuổi trẻ đáng giá bao nhiêu", author:"Rosie Nguyễn", category:"Tản văn", price:120000,
   img:"https://i.pinimg.com/736x/99/f3/60/99f360b56e5901ce2423ecbd5ca2de55.jpg",
   desc:"Sách truyền cảm hứng về phát triển bản thân và hành trình sự nghiệp."},
  {id:11, title:"Khởi nghiệp 4.0", author:"Nhiều tác giả", category:"Kinh tế", price:150000,
  ...
  {id:12, title:"Hãy sống ở thể chủ động", author:"Nguyễn Tuấn Quỳnh", category:"Tâm lý", price:88000,
  ...
  {id:13, title:"Làm đĩ", author:"Vũ Trọng Phụng", category:"Văn học", price:93000,img:"https://i.pinimg.com/736x/7f/41/c4/7f41c46ffc85489b239a5c3f2409f936.jpg",
  ...
  {id:14, title:"Tôi tài giỏi, bạn cũng thế!", author:"Adam Khoo", category:"Học tập", price:68000,
  ...
  {id:15, title:"Kể chuyện trước giờ đi ngủ", author:"Nhiều tác giả", category:"Thiếu nhi", price:59000,
   img:"https://i.pinimg.com/736x/0e/3b/59/0e3b59113b1887a735efc588e21ad34a.jpg",
   desc:"Tập hợp các câu chuyện ngắn ấm áp cho bé trước khi ngủ."},
  {id:16, title:"Bộ não và tâm trí", author:"Nhiều tác giả", category:"Tâm lý", price:99000,
  ...
  {id:17, title:"Bạn đắt giá bao nhiêu?", author:"Văn Tình", category:"Tản văn", price:70000,
  ...
  {id:18, title:"Một đời như kẻ tìm đường", author:"Phan Văn Trường", category:"Tiểu sử", price:95000,
  ...
  {id:19, title:"3 người thầy vĩ đại", author:"Robin Sharma", category:"Tâm lý", price:110000,
  ...
  {id:20, title:"Những tù nhân của địa lý", author:"Tim Marshall", category:"Học tập", price:125000,
  ...
  {id:21, title:"Tinh hoa trí tuệ do thái", author:"Từ Quang Á", category:"Kinh doanh", price:115000,
  ...
  {id:22, title:"Nghĩ giàu và làm giàu", author:"Napoleon Hill", category:"Kinh doanh", price:109000,
   img:"https://i.pinimg.com/736x/e6/2f/42/e62f42cd1f4a34ade468bd0ed00615c8.jpg",
   desc:"Cuốn sách kinh điển về phát triển tư duy thành công và làm giàu."},{id:23, title:"Hiểu về trái tim", author:"Minh Niệm", category:"Tâm lý", price:99000,
  ...
  {id:24, title:"Đừng bao giờ đi ăn một mình", author:"Keith Ferrazzi và Tahl Raz", category:"Tâm lý", price:89000,
  ...
  {id:25, title:"Đọc vị bất kì ai", author:"David J. Lieberman", category:"Tâm lý", price:113000,
  ...
  {id:26, title:"Ra bờ suối ngắm hoa kèn hồng", author:"Nguyễn Nhật Ánh", category:"Văn học", price:97000,
  ...
  {id:27, title:"Con chim xanh biếc quay về", author:"Nguyễn Nhật Ánh", category:"Tản văn", price:99000,
...
/* ===== Search logic (basic + advanced combined) ===== */
function doSearch(){
  ...
  filtered = books.filter(b=>{const byName = !name || b.title.toLowerCase().includes(name);
...
function openModal(book){
  ...
  document.getElementById('modalCategory').textContent = 'Phân loại: ' + book.category;
...
/* ===== Hàm addToCart (ĐÃ CẬP NHẬT HOÀN TOÀN) ===== */
function addToCart(book, quantityToAdd) {
  
  // 1. KIỂM TRA ĐĂNG NHẬP (từ sessionStorage)
  ...
  // 2. LẤY CƠ SỞ DỮ LIỆU USERS (từ localStorage)
  let users = JSON.parse(localStorage.getItem('users') || '[]');
  const loggedInUser = JSON.parse(loggedInUserJSON);

  // 3. TÌM NGƯỜI DÙNG HIỆN TẠI TRONG CSDL
  ...
  // 5. THÊM SẢN PHẨM VÀO GIỎ HÀNG (logic cũ)
  ...
  if (existingItem) {
    ...
    // Nếu chưa, thêm vào giỏ với số lượng mới
    cart.push({
      id: book.id,
      title: book.title,
      img: book.img,
  ...
  // 6. LƯU LẠI GIỎ HÀNG VÀO ĐÚNG USER ĐÓ
  users[userIndex].cart = cart;
  
  // 7. LƯU LẠI TOÀN BỘ CSDL USERS VÀO LOCALSTORAGE
  localStorage.setItem('users', JSON.stringify(users));
  
  // 8. CẬP NHẬT LẠI SESSION STORAGE
  // (Để trang giỏ hàng có thể thấy ngay lập tức)
  sessionStorage.setItem('currentUser', JSON.stringify(users[userIndex]));

  // 9. THÔNG BÁO VÀ ĐÓNG MODAL
...
/* Accessibility: keyboard navigation between cards */
